// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/xec_libs/data/unisims/RAMB36SDP_EXP.v,v 1.3 2008/08/11 22:17:44 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
module RAMB36SDP_EXP (DBITERR, DO, DOP, ECCPARITY, SBITERR, 
    ...
    pulldown di_port[63:0] (DI);
    pulldown dip_port[7:0] (DIP);
    pulldown rdaddru_port[14:0] (RDADDRU);
    pulldown wraddru_port[14:0] (WRADDRU);
    pulldown rdaddrl_port[15:0] (RDADDRL);
    pulldown wraddrl_port[15:0] (WRADDRL);
    ...
    ARAMB36_INTERNAL INT_RAMB (.DIA(64'b0), .ENA(RDENL), .WEA(8'b0), .SSRA(SSRL), .ADDRA(RDADDRL), .CLKA(RDCLKL), .DOA(DO), .DIB(DI), .ENB(WRENL), .WEB(WEL), .SSRB(1'b0), .ADDRB(WRADDRL), .CLKB(WRCLKL), .DOB(dangle_out32), .DOPA(DOP), .DOPB(dangle_out4), .DIPA(4'b0), .DIPB(DIP), .CASCADEOUTLATA(dangle_out), .CASCADEOUTLATB(dangle_out), .CASCADEOUTREGA(dangle_out), .CASCADEOUTREGB(dangle_out), .CASCADEINLATA(1'b0), .CASCADEINLATB(1'b0), .CASCADEINREGA(1'b0), .CASCADEINREGB(1'b0), .REGCEA(REGCEL), .REGCEB(1'b0), .REGCLKA(RDRCLKL), .REGCLKB(1'b0), .DBITERR(DBITERR), .ECCPARITY(ECCPARITY), .SBITERR(SBITERR));
